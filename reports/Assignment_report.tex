...
\usepackage{amsmath,mathtools,amsfonts,amsthm, mathalfa}
\usepackage{float}
...
\subsubsubsection{\bf Triplet Loss}
...
\subsubsubsection{\bf Kiến trúc mạng dựa trên Triplet Loss}
...
\bibitem{img-vgg}
Davi Frossard. VGG in TensorFlow. Truy xuất từ: \texttt{\burl{https://www.cs.toronto.edu/~frossard/post/vgg16/}}
...
\bibitem{kmean}
Luca Mel. K-means Clustering in Python . Truy xuất từ: \texttt{\burl{https://medium.com/data-py-blog/k-means-clustering-in-python-4fc8caa0e0d9}}
